...
if($bo_table == "counsel" || $bo_table == "community"){
    $sch_display = "displaynone";
}


// add_stylesheet('css 구문', 출력순서); 숫자가 작을 수록 먼저 출력됨
add_stylesheet('<link rel="stylesheet" href="/css/m_sub.css">', 0);
...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_subject" style="padding-left:<?php echo $list[$i]['reply'] ? (strlen($list[$i]['wr_reply'])+1*10) : '10'; ?>px">
                <?php
    ...
    <?php } ?>
       ...
       <!-- 게시판 검색 시작 { -->
    <fieldset id="bo_sch" class="<?php echo $sch_display ?>">
